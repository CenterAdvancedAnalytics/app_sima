...
def update_data():
    ...
    try:
        ...
        temp_coctel_fuente_actores.to_parquet("app/tables/temp_coctel_fuente_actores.cparquetsv", index=False)
...
DB_USER = 'doadmin'
DB_PASSWORD = 'AVNS__ssV8oPQHqrByI_-sTu'
DB_HOST = 'db-usaid-do-user-17996448-0.e.db.ondigitalocean.com'
DB_PORT = '25060'
DB_NAME = 'simadb'
